...
import tech.pegasys.teku.beaconrestapi.handlers.v1.beacon.PostExecutionProof;
import tech.pegasys.teku.infrastructure.restapi.RestApiBuilder;
import tech.pegasys.teku.spec.Spec;
import tech.pegasys.teku.spec.SpecMilestone;
import tech.pegasys.teku.spec.schemas.SchemaDefinitionCache;

public class ElectraRestApiBuilderAddon implements RestApiBuilderAddon {

  final Spec spec;
  final DataProvider dataProvider;
  final SchemaDefinitionCache schemaCache;

  public ElectraRestApiBuilderAddon(
  ...
  public RestApiBuilder apply(final RestApiBuilder builder) {
    return builder.endpoint(new PostExecutionProof(dataProvider, schemaCache));
  }
}
